# -*- coding: utf-8 -*-
"""
Created on Sun Jan  1 13:26:37 2023
...
def load_cub200(args):
    ...
    train_dataset = CUB200(root='../dataset/CUB200',
                                download=False,
                                train=True, 
                                w_transform=weak_transform, 
                                s_transform=strong_transform, 
                                partial_rate=args.partial_rate,
                                noisy_rate=args.noise_rate) 
    test_dataset = CUB200(root='../dataset/CUB200',
                               download=False, 
                               train=False, 
    ...
    test_loader = torch.utils.data.DataLoader(dataset=test_dataset, batch_size=args.batch_size*4, shuffle=False, num_workers=4)
...
class CUB200(torch.utils.data.Dataset):
    ...
    def __init__(self, root, train=True, w_transform=None,s_transform=None, test_transform=None,target_transform=None,
        ...
        if self._train:
            ...
            self.plabels = self._train_labels
            self.dlabels = self.true_labels
        else:
            ...
            self.dlabels=self._test_labels

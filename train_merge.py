...
from datasets.cifar100N import load_cifar100N
...
def train(args, epoch, train_loader,model, loss_fn, loss_cont_fn, optimizer):
    ...
    #     piror = min(args.piror  + (epoch-args.piror_start)*args.piror_add,args.piror_max)
    # else:
    #     piror = args.piror
    margin = []
    ...
    if epoch>=args.piror_start:
        if args.noise_rate>0:
            ...
            elif args.piror_auto == 'case2': #Adaptive adjustment 2
                args.piror = sorted(margin)[int(len(margin)*min(args.noise_rate,args.noise_rate*(epoch-args.piror_start)/args.mepoch))]
...
if __name__ == '__main__':
    ...
    if args.dataset == 'cifar10':
        ...
        args.num_class = 100
        train_loader,train_givenY, test_loader = load_cifar100N(args)
